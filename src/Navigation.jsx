...
function Navigation () {
	...
	return (
		<ul className="bg-white grid grid-cols-5 items-center gap-2 text-xs fixed bottom-0 inset-x-0 rounded-t-[3rem] shadow-[0_-8px_25px_rgba(0,0,0,0.07)]" >
			{navs.map(nav => {
  ...
  return (
    <li>
      <a
        ...
        className={`flex flex-col items-center justify-center py-8 px-6 text-gray-400 ${
